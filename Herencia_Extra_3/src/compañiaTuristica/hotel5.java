...
public final class hotel5 extends hotel {
    ...
    private int numLimosinas;

    public hotel5() {
    }

    public hotel5(String gym, String nombreRestaurant, double capasidadRestaurant, int numSalones, int numSuits, int numLimosinas, int habitaciones, int numCamas, double precioHabitacion, int numPisos, String nombre, String direccion, String localidad, String gerente) {
    ...
    public void agregadoRestaurant() {
      ...
      public void agregadoLimosinas(){
        
          precioHabitacion = precioHabitacion + (numLimosinas * 15);
    }
    ...
    public void precioFinal() {
        ...
        System.out.println("El precio por habitacion del hotel " + nombre + " es de " + precioHabitacion + " por habitacion");
